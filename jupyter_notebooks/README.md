...
<img src="../website/static/photo/CNN_RNN.png" width="100%">
...
* To create *Training Samples*, we use **OpenCV** to split video data into static frames(224x224) at 2 frames per second and save entire dataset as **Numpy Array**.
